...
class TodoApi {
  ...
  Future<Task> addTask(Task task) async {
    ...
    if (debug) {
      print('TodoApi: POST $path responseStatus=${resp.statusCode} data=${resp.data}');
    }
  ...
  Future<Task> updateTask(Task task) async {
    ...
    if (debug) {
      print('TodoApi: PUT $path responseStatus=${resp.statusCode} data=${resp.data}');
    }
    return _fromJson(resp.data);
  }
  ...
  Future<void> deleteTask(String id) async {
    ...
    if (debug) {
      print('TodoApi: DELETE $path responseStatus=${resp.statusCode} data=${resp.data}');
    }
  }
